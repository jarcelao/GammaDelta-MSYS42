    ...
    <div class="dropdown w-75">
        <a href="#" class="nav-link p-0 d-flex align-items-center" data-bs-toggle="dropdown">
            ...
            <span class="d-block small">
                ...
                <span class="text-light d-block text-ellipsis">{{Auth::user()->presenter()->subTitle()}}</span>
            </span>
        </a>
        <div class="dropdown-menu dropdown-menu-dark dropdown-menu-left dropdown-menu-arrow">
